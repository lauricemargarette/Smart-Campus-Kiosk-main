...
const IDLE_TIME    =  2 * 45 * 1000  // 45 seconds-----------------------------------------
...
export default function IdleTimeout() {
  ...
  useEffect(() => {
    ...
    const initTimer = window.setTimeout(resetTimer, 0)
    return () => {
  ...
  useEffect(() => {
    const pageChangeTimer = window.setTimeout(resetTimer, 0)
    return () => window.clearTimeout(pageChangeTimer)
