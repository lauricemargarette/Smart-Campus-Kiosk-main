...
const styles = {
  ...
  recoChip: { background: 'rgba(124,124,240,0.15)', backdropFilter: 'blur(8px)', border: '1px solid rgba(124,124,240,0.4)', borderRadius: '24px', padding: '7px 16px', color: '#9B9BF5', fontSize: '15px', cursor: 'pointer', minHeight: '44px', fontFamily: "'Inter',sans-serif" },
