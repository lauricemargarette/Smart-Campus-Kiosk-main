...
export const LOCATIONS = [
  ...
  { id:15, name:'Window 1 - Registrar',   floor:1, building:1, x:15,   y:11,   type:'registrar', desc:'Registrar Office - Window 1' },
  { id:16, name:'Window 2 - Registrar',   floor:1, building:1, x:13.8, y:11,   type:'registrar', desc:'Registrar Office - Window 2' },
  { id:17, name:'Window 3 - Registrar',   floor:1, building:1, x:12.5, y:11,   type:'registrar', desc:'Registrar Office - Window 3' },
  { id:18, name:'Window 4 - Registrar',   floor:1, building:1, x:11.5, y:11.4, type:'registrar', desc:'Registrar Office - Window 4' },
  { id:19, name:'Window 5 - Registrar',   floor:1, building:1, x:11.5, y:12.5, type:'registrar', desc:'Registrar Office - Window 5' },
  { id:20, name:'Window 6 - Registrar',   floor:1, building:1, x:11.5, y:13.6, type:'registrar', desc:'Registrar Office - Window 6' },
  { id:21, name:'Window 7 - Registrar',   floor:1, building:1, x:11.5, y:14.7, type:'registrar', desc:'Registrar Office - Window 7' },
  { id:22, name:'Window 8 - Registrar',   floor:1, building:1, x:11.5, y:15.9, type:'registrar', desc:'Registrar Office - Window 8' },
  { id:23, name:'Window 9 - Registrar',   floor:1, building:1, x:11.5, y:17.1, type:'registrar', desc:'Registrar Office - Window 9' },
  { id:24, name:'Window 12 - Registrar',  floor:1, building:1, x:11.5, y:18.3, type:'registrar', desc:'Registrar Office - Window 12' },
  { id:25, name:'Window 14 - Registrar',  floor:1, building:1, x:11.5, y:19.4, type:'registrar', desc:'Registrar Office - Window 14' },
  { id:26, name:'Window 15 - Registrar',  floor:1, building:1, x:11.5, y:20.6, type:'registrar', desc:'Registrar Office - Window 15' },
  ...
  { id:34, name:'Window 1 - Accounting',  floor:1, building:1, x:17.7, y:11,   type:'accounting',desc:'Accounting Office - Window 1' },
  { id:35, name:'Window 2 - Accounting',  floor:1, building:1, x:18.3, y:11,   type:'accounting',desc:'Accounting Office - Window 2' },
  { id:36, name:'Window 3 - Accounting',  floor:1, building:1, x:18.9, y:11,   type:'accounting',desc:'Accounting Office - Window 3' },
  { id:37, name:'Window 4 - Accounting',  floor:1, building:1, x:19.5, y:11,   type:'accounting',desc:'Accounting Office - Window 4' },
  { id:38, name:'Window 5 - Accounting',  floor:1, building:1, x:20.1, y:11,   type:'accounting',desc:'Accounting Office - Window 5' },
  { id:39, name:'Window 6 - Accounting',  floor:1, building:1, x:20.5, y:12.1, type:'accounting',desc:'Accounting Office - Window 6' },
  { id:40, name:'Window 7 - Accounting',  floor:1, building:1, x:20.5, y:13.2, type:'accounting',desc:'Accounting Office - Window 7' },
  { id:41, name:'Window 8 - Accounting',  floor:1, building:1, x:20.5, y:14.3, type:'accounting',desc:'Accounting Office - Window 8' },
  { id:42, name:'Window 9 - Accounting',  floor:1, building:1, x:20.5, y:15.4, type:'accounting',desc:'Accounting Office - Window 9' },

  // ── Building 2 — Ground Floor ──────────────────────────────
  { id:'hrm', name:'HRM Tools & Equipment',  floor:1, building:2, x:11.5, y:4.3,  type:'laboratory',desc:`HRM Tools and Equipments\nStorage facility for hospitality, culinary, and restaurant management equipment, and training materials.` },
  { id:'B2.11', name:'B2.11',                  floor:1, building:2, x:17,   y:8,    type:'laboratory',desc:`Computer Hardware Servicing\nElectronics/Electrical Room\n\nEquipped for hands-on electronics and electrical engineering experiments.` },
  { id:'B2.12', name:'B2.12',                  floor:1, building:2, x:15,   y:8,    type:'room',      desc:'Academic Lecture Room, AVR Extension Room-2.' },
  { id:'supply', name:'Supply Section',         floor:1, building:2, x:20.5, y:4,    type:'facility',  desc:'Handles procurement and inventory management for the college.' },
  { id:'lib', name:'Library',                floor:1, building:2, x:20.5, y:1.5,  type:'library',   desc:'Provides study resources and study area for student research and reading.' },
  ...
  { id:'B4.11',  name:'B4.11',            floor:1, building:4, x:1.5, y:7.5,  type:'laboratory',desc:`CHEMISTRY LABORATORY\nUsed for chemistry experiments and photography development.` },
  { id:'B4.12',  name:'B4.12',            floor:1, building:4, x:1.5, y:5.5,  type:'laboratory',desc:`PHYSICS LABORATORY\nEquipped for physics experiments and demonstrations.` },
  { id:'B4.13',  name:'B4.13',            floor:1, building:4, x:10.5, y:7.5, type:'laboratory',desc:`ENGINEERING LABORATORY\nHands-on space for engineering coursework and projects.` },
  { id:'B4.14',  name:'B4.14',            floor:1, building:4, x:10.5, y:5.4, type:'laboratory',desc:`FORENSIC LABORATORY\nUsed for forensic science training and analysis.` },
  { id:'B4.15',  name:'B4.15',            floor:1, building:4, x:10.5, y:3.3, type:'laboratory',desc:`CULINARY DEMO ROOM\nUsed for culinary instruction and cooking demonstrations.` },
  { id:'B4.16',  name:'B4.16',            floor:1, building:4, x:10.5, y:1.2, type:'laboratory',desc:`FUNCTION ROOM\nMulti-purpose room for events and gatherings.` },
  { id:'B4.17',  name:'B4.17',            floor:1, building:4, x:4.8, y:2,    type:'laboratory',desc:`COLD KITCHEN\nUsed for food prep that doesn't require cooking, like salads and pastries.` },
  { id:'B4.18',  name:'B4.18',            floor:1, building:4, x:2.6, y:2,    type:'laboratory',desc:`HOT KITCHEN\nUsed for cooking-based culinary training.` },
  ...
  { id:'B1.21', name:"B1.21",                                                 floor:2, building:1, x:17.8, y:17.5, type:"laboratory", desc:"Judicial Court Simulation Laboratory."},
  ...
  { id:56, name:"Server Room",            floor:2, building:3,  x:7,    y:13.3, type:"office",    desc:"Technical office of MIS Employees."},
  ...
  { id:111, name: "Building 2 & 4 Mid-Hallway",  floor:1, x:11,   y:7.5,  type: "hallway", desc: "Corridor in front of B4.13." },
  { id:112, name: "Building 2 & 4 Mid-Hallway",  floor:1, x:11,   y:5.4,  type: "hallway", desc: "Corridor in front of B4.14." },
  ...
  { id:133, name: "Building 4 Hallway",          floor:1, x: 1,   y:10.5, type: "hallway", desc: "Building 4 Hallway."},
  { id:134, name: "Building 4 - Side Hallway",   floor:1, x: 1,   y:7.5,  type: "hallway", desc: "In front of B4.11."},
  ...
  { id:232, name: "Building 2 & 4 Mid-Hallway",  floor:1, x:11,   y:3.3,  type: "hallway", desc: "Corridor in front of B4.15." },
  { id:233, name: "Building 2 & 4 Mid-Hallway",  floor:1, x:11,   y:4.3,  type: "hallway", desc: "Corridor in front of HRM Tools & Equipments." },
  { id:234, name: "Building 2 & 4 Mid-Hallway",  floor:1, x:11,   y:1.2,  type: "hallway", desc: "Corridor in front of B4.16." },
  { id:235, name: "Building 4 - Side Hallway",   floor:1, x: 1,   y:5.5,  type: "hallway", desc: "In front of B4.12."},
  { id:236, name: "Building 4 - Kitchen Hallway",floor:1, x: 1,   y:2.5,  type: "hallway", desc: "Hallway to Kitchen."},
  { id:237, name: "Building 4 - Kitchen Hallway",floor:1, x: 2.6,   y:2.5,  type: "hallway", desc: "In front of B4.18."},
  { id:238, name: "Building 4 - Kitchen Hallway",floor:1, x: 4.8,   y:2.5,  type: "hallway", desc: "In front of B4.17."},
  ...
  { id:220,     name: "Building 1 Hallway",          floor:2, x: 16.5, y:13.3, type: "hallway", desc: "In front of Faculty Room."},
...
export const EDGES = [
  ...
  [200,116],[200,117],[200,146],[113,'B2.12'],[114,116],[116,117],[116,'B2.11'],[117,118],[118,'supply'],
  [117,119],[119,'lib'],[110,120],[110,121],[110,122],[110,123],[110,124],[110,125],[110,126],[110,127],
  [110,128],[110,135],[110,146],[120,18],[121,19],[122,20],[123,21],[124,22],[125,23],[126,24],
  [127,25],[128,26],[135,136],[146,147],[110,233],[233,'hrm'],
  ...
  [111,'B4.13'],[112,'B4.14'],[133,134],[110,232],[110,234],[232,'B4.15'],[234,'B4.16'],[134,'B4.11'],[133,235],
  [235,'B4.12'],[133,236],[236,237],[236,238],[237,'B4.18'],[238,'B4.17'],

  //Building 1 - Second Floor Edges
  [218,219],[219,48],[219,53],[219,220],[219,223],[219,224],[220,49],[219,222],[222,50],
  [223,'B1.21'],[224,51],[224,55],
...
export const FLOOR_BLOCKS = {
  1: [
    ...
    { x:16,   y:5.5, w:4.5, h:2.5, label:'Electronics/Electrical Laboratory', type:'laboratory' },
    ...
    { x:0.5, y:16,   w:2.3, h:1.5, label:`Women's Restroom`,         type:'facility' },
    { x:0.5, y:14.3, w:1.3, h:1.7, label:`Men's Restroom`,         type:'facility' },
    // Building 4 rooms
    { x:6,    y:0,   w:4.5,   h:2.1, label:'Function Room (B4.16)',          type:'laboratory' },
    { x:6,    y:2.1, w:4.5,   h:2.2, label:'Culinary Demo Room (B4.15)',     type:'laboratory' },
    { x:6,    y:4.3, w:4.5,   h:2.1, label:'Forensic Laboratory (B4.14)',    type:'laboratory' },
    { x:6,    y:6.4, w:4.5,   h:2.1, label:'Engineering Laboratory (B4.13)', type:'laboratory' },
    { x:1.5,  y:6.5, w:4.5,   h:2,   label:'Chemistry Laboratory (B4.11)',   type:'laboratory' },
    { x:1.5,  y:4.5, w:4.5,   h:2,   label:'Physics Laboratory (B4.12)',     type:'laboratory' },
    { x:3.75, y:0,   w:2.25,  h:2,   label:'Cold Kitchen (B4.17)',           type:'kitchen' },
    { x:1.5,  y:0,   w:2.25,  h:2,   label:'Hot Kitchen (B4.18)',            type:'kitchen' },
  ...
  2: [
    ...
    // Restrooms
    { x:10,   y:8,  w:2,     h:1.5, label:`Men's Restroom`,   type:'facility' },
    { x:20,   y:8,  w:1.5,   h:2,   label:`Women's Restroom`, type:'facility' },
    //Building 1 rooms
    {x:17.8,  y:18.3, w:3.7, h:2.7, label:'Office of the College Deans',                           type:'office'},
    {x:17.8,  y:16.8, w:3.7, h:1.5, label:'Judicial Court Simulation Lab (B1.21)',                 type:'laboratory'},
    {x:17.8,  y:12.8, w:3.7, h:1.5, label:'Judicial Court Simulation Lab (B1.21)',                 type:'laboratory'},
    ...
    // Building 2 rooms
    { x:11.5, y:0,   w:4,   h:2.6, label:'Computer Laboratory (B2.23)', type:'laboratory' },
    { x:11.5, y:2.6, w:4,   h:2.7, label:'Computer Laboratory (B2.22)', type:'laboratory' },
    { x:11.5, y:5.3, w:4,   h:2.7, label:'Computer Laboratory (B2.21)', type:'laboratory' },
    { x:17.5, y:0,   w:4,   h:2.6, label:'Computer Laboratory (B2.26)', type:'laboratory' },
    { x:17.5, y:2.6, w:4,   h:2.7, label:'Computer Laboratory (B2.25)', type:'laboratory' },
    { x:17.5, y:5.3, w:4,   h:2.7, label:'Computer Laboratory (B2.24)', type:'laboratory' },
    ...
    {x:7,   y:12.5, w:3.5, h:1.5, label:'Server Room',            type:'office'},
    {x:7,   y:14,   w:3.5, h:1.5, label:"",                       type:'facility'},
    {x:7.5, y:15.5, w:3,   h:1,   label:'Stairs',                 type:'stairs'},
    {x:4.8, y:19.7, w:1.4, h:1.3, label:'Stairs',                 type:'stairs'},
    // Building 4 rooms
    { x:0.5, y:8,   w:1,   h:2,   label:`Women's Restroom`,            type:'facility' },
    { x:5,   y:9,   w:1,   h:1,   label:'Elevator',                    type:'elevator' },
    { x:0.5, y:4,   w:4,   h:4,   label:'CISCO Networking Laboratory (B4.21)',                  type:'laboratory' },
    { x:0.5, y:0,   w:4,   h:4,   label:'Speech Laboratory (B4.22)',           type:'laboratory' },
    { x:6.5, y:5.2, w:4,   h:2.8, label:'DRM Laboratory (B4.23)',              type:'laboratory' },
    { x:6.5, y:2.5, w:4,   h:2.7, label:'E-Learning Hub (B4.24)',              type:'laboratory' },
    { x:6.5, y:0,   w:4,   h:2.5, label:'Senior High School Dept. (B4.25)',    type:'office' },
  ...
  3: [
    ...
    {x:5, y:9, w:1, h:1, label:"Elevator",type:'elevator'},
    //Building 1 rooms
    {x:17,   y:18.5, w:4.5, h:2.5, label:'Administration & Human Resources Office (AHRO)',   type:'office'},
    {x:11.5, y:18.5, w:4.1, h:2.5, label:'Special Projects Affiliations & Marketing Office (SPAMO)',  type:'office'},
    {x:15.6, y:19.7, w:1.4, h:1.3, label:'Stairs', type:'stairs'},
    {x:10.5, y:18.5, w:1,   h:2.5, label:'Stairs', type:'stairs'},
    //Building 2 rooms
    {x:11.5, y:6, w:4,   h:2,   label:'Lecture Room (B2.31)',            type:'room'},
    {x:11.5, y:4, w:4,   h:2,   label:'Lecture Room (B2.32)',            type:'room'},
    {x:11.5, y:2, w:4,   h:2,   label:'Lecture Room (B2.33)',            type:'room'},
    {x:11.5, y:0, w:4,   h:2,   label:'Online Teaching Hub - B (B2.34)', type:'facility'},
    {x:17.5, y:6, w:4,   h:2,   label:'Lecture Room (B2.35)',            type:'room'},
    {x:17.5, y:4, w:4,   h:2,   label:'Lecture Room (B2.36)',            type:'room'},
    {x:17.5, y:2, w:4,   h:2,   label:'Lecture Room (B2.37)',            type:'room'},
    {x:17.5, y:0, w:4,   h:2,   label:'Online Teaching Hub - A (B2.38)', type:'facility'},
    {x:12,   y:8, w:2,   h:1.5, label:'Stairs',                          type:'stairs'},
    {x:18,   y:8, w:2,   h:1.5, label:'Stairs',                          type:'stairs'},
    {x:20,   y:8, w:1.5, h:2,   label:`Women's Restroom`,                type:'facility'},
    //Building 3 rooms
    {x:6.2, y:18.5, w:4.3, h:2.5, label:'Varsity Room - Female', type:'facility'},
    {x:0.5, y:18.5, w:4.3, h:2.5, label:'Varsity Room - Male',   type:'facility'},
    {x:4.8, y:19.7, w:1.4, h:1.3, label:'Stairs',                  type:'stairs'},
    //Building 4 rooms
    {x:0.5, y:6, w:4, h:2,   label:'Lecture Room (B4.31)', type:'room'},
    {x:0.5, y:4, w:4, h:2,   label:'Lecture Room (B4.32)', type:'room'},
    {x:0.5, y:2, w:4, h:2,   label:'Lecture Room (B4.33)', type:'room'},
    {x:0.5, y:0, w:4, h:2,   label:'Lecture Room (B4.34)', type:'room'},
    {x:6.5, y:6, w:4, h:2,   label:'Lecture Room (B4.35)', type:'room'},
    {x:6.5, y:4, w:4, h:2,   label:'Lecture Room (B4.36)', type:'room'},
    {x:6.5, y:2, w:4, h:2,   label:'Lecture Room (B4.37)', type:'room'},
    {x:6.5, y:0, w:4, h:2,   label:'Lecture Room (B4.38)', type:'room'},
    {x:1.5, y:8, w:2, h:1.5, label:'Stairs',       type:'stairs'},
    {x:8,   y:8, w:2, h:1.5, label:'Stairs',       type:'stairs'},
    {x:0.5, y:8, w:1, h:2,   label:`Women's Restroom`,     type:'facility'},
    {x:10,  y:8, w:2, h:1.5, label:`Men's Restroom`,     type:'facility'},
  ...
  4: [
    ...
    {x:10.5, y:18.5, w:1,  h:2.5, label:'Stairs',     type:'stairs'},
    //Building 2 rooms
    {x:11.5, y:6, w:4,   h:2,   label:'Lecture Room (B2.41)', type:'room'},
    {x:11.5, y:4, w:4,   h:2,   label:'Lecture Room (B2.42)', type:'room'},
    {x:11.5, y:2, w:4,   h:2,   label:'Lecture Room (B2.43)', type:'room'},
    {x:11.5, y:0, w:4,   h:2,   label:'Lecture Room (B2.44)', type:'room'},
    {x:17.5, y:6, w:4,   h:2,   label:'Lecture Room (B2.45)', type:'room'},
    {x:17.5, y:4, w:4,   h:2,   label:'Lecture Room (B2.46)', type:'room'},
    {x:17.5, y:2, w:4,   h:2,   label:'Lecture Room (B2.47)', type:'room'},
    {x:17.5, y:0, w:4,   h:2,   label:'Lecture Room (B2.48)', type:'room'},
    {x:12,   y:8, w:2,   h:1.5, label:'Stairs',               type:'stairs'},
    {x:18,   y:8, w:2,   h:1.5, label:'Stairs',               type:'stairs'},
    {x:20,   y:8, w:1.5, h:2,   label:`Women's Restroom`,     type:'facility'},
    //Building 3 rooms
    ...
    //Building 4 rooms
    {x:0.5, y:6, w:4, h:2,   label:'Lecture Room (B4.41)', type:'room'},
    {x:0.5, y:4, w:4, h:2,   label:'Lecture Room (B4.42)', type:'room'},
    {x:0.5, y:2, w:4, h:2,   label:'Lecture Room (B4.43)', type:'room'},
    {x:0.5, y:0, w:4, h:2,   label:'Lecture Room (B4.44)', type:'room'},
    {x:6.5, y:6, w:4, h:2,   label:'Lecture Room (B4.45)', type:'room'},
    {x:6.5, y:4, w:4, h:2,   label:'Lecture Room (B4.46)', type:'room'},
    {x:6.5, y:2, w:4, h:2,   label:'Lecture Room (B4.47)', type:'room'},
    {x:6.5, y:0, w:4, h:2,   label:'Lecture Room (B4.48)', type:'room'},
    {x:1.5, y:8, w:2, h:1.5, label:'Stairs',       type:'stairs'},
    {x:8,   y:8, w:2, h:1.5, label:'Stairs',       type:'stairs'},
    {x:0.5, y:8, w:1, h:2,   label:`Women's Restroom`,     type:'facility'},
    {x:10,  y:8, w:2, h:1.5, label:'Restroom',     type:'facility'},
  ...
  5:[
    ...
    {x:10,   y:8,   w:2,   h:1.5, label:'Restroom', type:'facility'},
    //Building 2 rooms
    {x:17.5, y:6, w:4,   h:2,   label:'Lecture Room (B2.55)', type:'room'},
    {x:17.5, y:4, w:4,   h:2,   label:'Lecture Room (B2.56)', type:'room'},
    {x:17.5, y:2, w:4,   h:2,   label:'Lecture Room (B2.57)', type:'room'},
    {x:17.5, y:0, w:4,   h:2,   label:'Lecture Room (B2.58)', type:'room'},
    {x:11.5, y:4, w:4,   h:2,   label:'Lecture Room (B2.52)', type:'room'},
    {x:11.5, y:6, w:4,   h:2,   label:'Lecture Room (B2.51)', type:'room'},
    {x:11.5, y:2, w:4,   h:2,   label:'Lecture Room (B2.53)', type:'room'},
    {x:11.5, y:0, w:4,   h:2,   label:'Lecture Room (B2.54)', type:'room'},
    {x:12,   y:8, w:2,   h:1.5, label:'Stairs',       type:'stairs'},
    {x:18,   y:8, w:2,   h:1.5, label:'Stairs',       type:'stairs'},
    {x:20,   y:8, w:1.5, h:2,   label:'Restroom',     type:'facility'},
    //Building 4 rooms
    {x:6.5, y:4, w:4, h:2,   label:"Lecture Room (B4.56)", type:'room'},
    {x:6.5, y:2, w:4, h:2,   label:"Lecture Room (B4.57)", type:'room'},
    {x:6.5, y:0, w:4, h:2,   label:"Lecture Room (B4.58)", type:'room'},
    {x:6.5, y:6, w:4, h:2,   label:"Lecture Room (B4.55)", type:'room'},
    {x:0.5, y:4, w:4, h:2,   label:"Lecture Room (B4.52)", type:'room'},
    {x:0.5, y:6, w:4, h:2,   label:"Lecture Room (B4.51)", type:'room'},
    {x:0.5, y:2, w:4, h:2,   label:"Lecture Room (B4.53)", type:'room'},
    {x:0.5, y:0, w:4, h:2,   label:"Lecture Room (B4.54)", type:'room'},
    {x:1.5, y:8, w:2, h:1.5, label:"Stairs",       type:'stairs'},
    {x:8,   y:8, w:2, h:1.5, label:"Stairs",       type:'stairs'},
  ...
  6:[
    ...
    {x:1.3, y:4.8, w:8.5, h:2.5, label:"",                                  type:'chairs'},
  ...
  7: [
    ...
    {x:0.5, y:0,   w:10,  h:10,  label:'Building 4', type:'building' },
    {x:1.3, y:2.3, w:8.5, h:2.5, label:"Chairs",     type:'chairs'},
    {x:0.5, y:4.5, w:10,  h:3.5, label:"",           type:'chairs'},
...
export const TYPE_META = {
  entrance:  { color:'#f87171', icon:'🚪', fill:'#0c3028' },
  office:    { color:'#60a5fa', icon:'🏢', fill:'#112240' },
  registrar: { color:'#60a5fa', icon:'🏢', fill:'#112240' },
  accounting:{ color:'#60a5fa', icon:'🏢', fill:'#112240' },
  library:   { color:'#60a5fa', icon:'📚', fill:'#1a0f2e' },
  laboratory:{ color:'#d6c61c', icon:'💻', fill:'#1a1500' },
  room:      { color:'#d6c61c', icon:'🎓', fill:'#0a1f2e' },
  lounge:    { color:'#60a5fa', icon:'🛋️', fill:'#1a0f00' },
  clinic:    { color:'#f87171', icon:'🏥', fill:'#1a0505' },
  restroom:  { color:'#1e3a5f', icon:'🚻', fill:'#051a18' },
  hallway:   { color:'#1e3a5f', icon:'',   fill:'#070f1e' },
  stairs:    { color:'#1e3a5f', icon:'🪜', fill:'#0a1020' },
  elevator:  { color:'#1e3a5f', icon:'🛗', fill:'#0a2030' },
  building:  { color:'#1e3a5f', icon:'🏗️', fill:'#0d1b2e' },
  facility:  { color:'#60a5fa', icon:'',   fill:'#111827' },
